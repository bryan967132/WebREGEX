...
break;
case 6:
console.log({tipo: 'SINTACTICO', descripcion: `No se esperaba "${yytext}".` ,  linea: this._$.first_line , columna: this._$.first_column + 1})
break;
case 7:
this.$ = getNode1($$[$0-1], $$[$0-2],   $$[$0],   $$[$0-2].anulable && $$[$0].anulable, Type.CONCAT  )
break;
case 8:
this.$ = getNode1($$[$0-1], $$[$0-2],   $$[$0],   $$[$0-2].anulable || $$[$0].anulable, Type.OR      )
break;
case 9:
this.$ = getNode1($$[$0], $$[$0-1],   null, true,                       Type.KLEENE  )
break;
case 10:
this.$ = getNode1($$[$0], $$[$0-1],   null, $$[$0-1].anulable,                Type.POSITIVE)
break;
case 11:
